...
class BK_INSImpactVC: UIViewController {
    ...
    func setupConstraints() {
        ...
        let formats: [String] = ["H:|[content]|",
                                 "V:|[content]|",
                                 "V:|[personal(150)]-[sep1(1)]-10-[title]-10-[sub]-15-[tutorial(315)]-[sep2(1)]-[learn]-[cum]-10-[sep3(1)]-12-[commTitle]-12-[tile]-[tile1]-[tile2]-[tile3]-|",
                                 "V:[sep2]-[powered]",
                                 "H:|[personal]|",
                                 "H:|-16-[sep1]-16-|",
                                 "H:|-16-[tutorial]-16-|",
...
extension BK_INSImpactVC {
    ...
    func impactDidLoad() {
        DispatchQueue.main.async {
            ...
            self.subLabel.text = impact.copy.subtitle
