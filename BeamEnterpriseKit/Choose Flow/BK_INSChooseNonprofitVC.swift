    ...
    func setupConstraints() {
        ...
        constraints += [ NSLayoutConstraint(item: contentView,
                         ...
                         NSLayoutConstraint(item: footer,
                                            ...
                                            multiplier: 1,
                                            constant: footer.selectButton.intrinsicContentSize.height + 40)
...
class BK_INSVisitHeaderView: UIView {
    ...
    func setup() {
        descriptionLabel.setTitle(transaction.storeNon.subtitle, for: .normal)
        descriptionLabel.setAttributedTitle(transaction.storeNon.subtitle?.bkhtmlAttributedString(with: 15), for: .normal)
